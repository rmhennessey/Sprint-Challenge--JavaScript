...
const lowerCase = zooAnimals.map(function(smallMe) {
  return smallMe.animal_name.toLowerCase();
});
...
*/
const largerPopulation = zooAnimals.filter((bigPop) => {
  if (bigPop.population < 5) {
    return bigPop;
  }
